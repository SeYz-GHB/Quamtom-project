...
const HoodyDetail = () => {
  const { id } = useParams();
  const hoodie = Object.values(data).find((item) => item.id === id);
    ...
    <div className="flex flex-col items-center justify-center p-6 w-full">
      <div className="flex flex-col md:flex-row items-center justify-center p-6">
        ...
        <div className="w-full md:w-1/2 p-6 space-y-4">
          <h1 className="text-3xl font-semibold">{hoodie.name}</h1>
          <p className="text-gray-400">{hoodie.description}</p>
          <p>
            <span className="font-semibold">Material:</span> {hoodie.materials.join(", ")}
          </p>
          ...
          <p>
            <span className="font-semibold">Logo Placement:</span> {hoodie.logoPlacement}
          </p>
          <p>
            <span className="font-semibold">Price:</span> ${hoodie.price}
          </p>
          ...
          <p className="italic text-gray-300">{hoodie.details}</p>
