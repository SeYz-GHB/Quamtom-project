...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="relative py-20 px-4 md:px-8 lg:px-16 text-center">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
            <span className="text-gray-300">Quantom</span>
          </h1>
      ...
      <div className='bg-white flex flex-row items-center justify-center h-[50px] w-full text-white'>
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="h-64 md:h-96 flex items-center justify-center">
            <img src={SeyImage} alt="CEO" className="w-[60%] h-[80%]  object-cover rounded-lg shadow-lg" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="h-64 md:h-96 flex items-center justify-center order-last md:order-first">
            <img src={RothImage} alt="CO-CEO" className="w-[60%] h-[80%] object-cover rounded-lg shadow-lg" />
          </div>
          <div>
